...
import com.diana.moviecatalog.databinding.MovieItemBinding
...
class MovieAdapter(
    ...
    private fun moveToMoviesDetail(movie: Movie, view: View) {
        val detailMoviesIntent = Intent(view.context, DetailMovieActivity::class.java).apply {
            putExtra(DetailMovieActivity.EXTRA_MOVIES, movie)
        }
